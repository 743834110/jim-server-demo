...
import org.jim.server.http.DefaultHttpRequestHandler;
...
/**
 * @author litianfeng
 * Created on 2018/0/21
 */
public class HttpProtocolHandler extends AbProtocolHandler {

    private Logger log = LoggerFactory.getLogger(org.jim.server.http.HttpProtocolHandler.class);
    ...
    public void init(ImConfig imConfig)throws Exception{
        ...
        httpRequestHandler = new CustomHttpRequestHandler(httpConfig, routes);
