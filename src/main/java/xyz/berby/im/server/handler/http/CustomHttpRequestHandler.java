package xyz.berby.im.server.handler.http;
...
import org.jim.server.http.FileCache;
 ...
 *
 */
public class CustomHttpRequestHandler implements IHttpRequestHandler {
    private static Logger log = LoggerFactory.getLogger(CustomHttpRequestHandler.class);
     ...
     * @author WChao
     */
    public CustomHttpRequestHandler(HttpConfig httpConfig) {
     ...
     * @author WChao
     */
    public CustomHttpRequestHandler(HttpConfig httpConfig, Routes routes) {
        this(httpConfig);
        this.routes = routes;
    }
        ...
        try {
            ...
            if (method != null) {
                ...
                if (fileCache != null) {
                    ...
                    File file = null;
                    String root = pageRoot;
                    if (StringUtils.startsWithIgnoreCase(pageRoot, "classpath:")) {
                        root = FileUtil.getAbsolutePath(pageRoot);
                    }
